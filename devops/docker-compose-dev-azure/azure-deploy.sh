...
resourcename="chending1"  # lower case, only
resourcegroup="chending1_rg"
...
# git clone https://github.com/apilogicserver/chending1.git
# cd chending1
...
az group create --name chending1_rg --location "westus"
az appservice plan create --name myAppServicePlan --resource-group chending1_rg --sku S1 --is-linux
az container create --resource-group chending1_rg --name chending1 --image apilogicserver/chending1:latest --dns-name-label chending1 --ports 5656 --environment-variables 'VERBOSE'='True'  'APILOGICPROJECT_CLIENT_URI'='//chending1.westus.azurecontainer.io:5656'
