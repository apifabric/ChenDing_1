...
@Component({
  selector: 'StoreLocation-home',
  templateUrl: './StoreLocation-home.component.html',
  styleUrls: ['./StoreLocation-home.component.scss']
})
export class StoreLocationHomeComponent implements AfterViewInit {
